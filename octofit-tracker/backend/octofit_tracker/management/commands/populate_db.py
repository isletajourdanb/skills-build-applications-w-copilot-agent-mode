...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        octo_models.Workout.objects.create(name='Morning Cardio', description='A quick morning run', duration=20)
        octo_models.Workout.objects.create(name='Strength Training', description='Upper body strength', duration=45)
